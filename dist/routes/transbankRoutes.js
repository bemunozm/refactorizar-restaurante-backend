...
class TransbankRoute {
    ...
    initRoutes() {
        ...
        this.router.get("/transaction/order/:onlineOrderId", validation_1.default.handleInputErrors, this.transbankController.getTransactionByOnlineOrderId.bind(this.transbankController));
    }
}
