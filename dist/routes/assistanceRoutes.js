...
class AssistanceRoute {
    ...
    initRoutes() {
        this.router.post("/create", auth_1.default.authenticate, 
        ...
        this.router.put("/update-status", auth_1.default.authenticate, 
        ...
        this.router.post("/assign", auth_1.default.authenticate, 
        ...
        this.router.post("/complete", auth_1.default.authenticate, 
        ...
        this.router.post("/confirm", auth_1.default.authenticate, 
