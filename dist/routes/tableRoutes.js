...
class TableRoute {
    ...
    initRoutes() {
        ...
        (0, express_validator_1.param)("id").isMongoId().withMessage("ID de mesa inválido."), validation_1.default.handleInputErrors, this.tableController.deleteTable.bind(this.tableController));
    }
}
