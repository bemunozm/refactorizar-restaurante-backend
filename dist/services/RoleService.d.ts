...
export declare class RoleService {
    getPermissions(): {
        ...
        "Gesti\u00F3n de Asistencia": import("../config/permissions").Permissions[];
        "Gesti\u00F3n de Descuentos": import("../config/permissions").Permissions[];
        "Gesti\u00F3n de Entregas": import("../config/permissions").Permissions[];
        "Gesti\u00F3n de Estad\u00EDsticas": import("../config/permissions").Permissions[];
    };
